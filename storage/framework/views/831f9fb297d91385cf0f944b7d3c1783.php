    ...
    <div class="community-layout">
      ...
      <div class="left-sidebar">
        ...
        <div class="sidebar-section">
          ...
          <ul class="quick-links">
            <li><i class="fas fa-calendar-alt"></i> <a href="<?php echo e(route('events.index')); ?>">Events</a></li>
            <li><i class="fas fa-shopping-cart"></i> <a href="<?php echo e(route('marketplace.index')); ?>">Marketplace</a></li>
      ...
      <div class="feed-main">
        <div class="create-post-card">
          <form action="<?php echo e(route('community.post.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="post-compose">
              <img src="<?php echo e(user_avatar(Auth::user())); ?>" alt="<?php echo e(Auth::user()->name); ?>" class="user-avatar">
            ...
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="post-card">
                ...
                <div class="post-header">
                  ...
                  <div class="post-meta-data">
                    <div class="author-name">
                      <a href="#" class="author-link"><?php echo e($post->user->name); ?></a>
                  ...
                  <div class="post-menu">
                    ...
                    <div class="menu-dropdown hidden">
                      <?php if(Auth::id() == $post->user_id): ?>
                        <a href="<?php echo e(route('community.post.edit', $post->id)); ?>"><i class="fas fa-edit"></i> Edit Post</a>
                        <a href="#" onclick="event.preventDefault(); document.getElementById('delete-post-<?php echo e($post->id); ?>').submit();"><i class="fas fa-trash"></i> Delete Post</a>
                        <form id="delete-post-<?php echo e($post->id); ?>" action="<?php echo e(route('community.post.destroy', $post->id)); ?>" method="POST" style="display: none;">
                          <?php echo csrf_field(); ?>
                ...
                <div class="post-content">
                  <p class="post-text"><?php echo e($post->content); ?></p>
                ...
                <div class="post-engagement">
                  <div class="engagement-stats">
                    <span class="likes-count">
                      <i class="fas fa-thumbs-up"></i> <?php echo e($post->likes_count ?? 0); ?>

                    </span>
                    <span class="comments-count">
                      <i class="fas fa-comment"></i> <?php echo e($post->comments_count ?? 0); ?>
        ...
        <?php if($posts->isEmpty()): ?>
          <div class="sample-post-section">
            ...
            <div class="post-card highlighted">
              <div class="post-header">
                <a href="#" class="post-author-link">
                  <img src="<?php echo e(user_avatar(null)); ?>" alt="Sarah J." class="post-avatar">
                </a>
            ...
            <div class="post-card">
              <div class="post-header">
                <a href="#" class="post-author-link">
                  <img src="<?php echo e(user_avatar(null)); ?>" alt="John D." class="post-avatar">
                </a>
        ...
        <section class="panel" id="top-contributors">
          ...
          <div class="panel-body">
            <div class="contributor-rankings">
              <?php $__empty_1 = true; $__currentLoopData = $topContributors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contributor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="contributor-card">
                  <div class="contributor-rank">#<?php echo e($loop->iteration); ?></div>
                  <img src="<?php echo e(user_avatar($contributor)); ?>" alt="<?php echo e($contributor->name); ?>" class="contributor-image">
                  <div class="contributor-details">
                    <h4 class="contributor-name"><?php echo e($contributor->name); ?></h4>
                    <div class="contributor-stats"><?php echo e($contributor->posts_count); ?> posts</div>
                  </div>
                </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="contributor-card">
                  ...
                  <img src="<?php echo e(user_avatar(null)); ?>" alt="John Doe" class="contributor-image">
                  <div class="contributor-details">
                ...
                <div class="contributor-card">
                  ...
                  <img src="<?php echo e(user_avatar(null)); ?>" alt="Jane Doe" class="contributor-image">
                  <div class="contributor-details">
                ...
                <div class="contributor-card">
                  ...
                  <img src="<?php echo e(user_avatar(null)); ?>" alt="Nick Doe" class="contributor-image">
                  <div class="contributor-details">
