                    ...
                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $imageUrl = file_exists(public_path($image['path'])) 
                                ...
                                : $image['fallback'];
                        ?>
                        <div class="slide <?php echo e($index === 0 ? 'active' : ''); ?>" style="background-image: url('<?php echo e($imageUrl); ?>');"></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="slide-controls">
                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="slide-dot <?php echo e($index === 0 ? 'active' : ''); ?>" data-slide="<?php echo e($index); ?>"></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        </div>
    ...
    <section id="how-it-works" class="how-it-works-section">
        <div class="container">
            ...
            <div class="cta-container">
                <a href="<?php echo e(route('register')); ?>" class="btn-primary">Join Your Neighborhood</a>
            </div>
        </div>
    </section>
    ...
    <section class="cta-section">
        <div class="container cta-container">
            <div class="cta-content">
                ...
                <a href="<?php echo e(route('register')); ?>" class="btn-primary">Get Started Now</a>
            </div>
        </div>
    </section>
