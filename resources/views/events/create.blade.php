...
<div class="debug-info" style="background:#f8f9fa; border:1px solid         <div class="image-upload">
          <div class="image-preview">
            ...
            <input type="file" name="image" id="image" style="display: none;" 
                  class="@error('image') is-invalid @enderror" accept=".jpg,.jpeg,.png,.gif">
...
<main class="create-event-page">
  <div class="container">
    <div class="page-header">
      ...
      <a href="{{ route('events.index') }}" class="back-link"><i class="fas fa-arrow-left"></i> Back to events</a>
    </div>
    ...
    <form class="event-form" method="POST" action="{{ route('events.store') }}" enctype="multipart/form-data" id="createEventForm">
      @csrf
      ...
      <div class="form-section">
        ...
        <div class="form-group">
          ...
          <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" 
                 placeholder="e.g. Block Party, Yard Sale" value="{{ old('title') }}" required>
          @error('title')
            <span class="invalid-feedback">{{ $message }}</span>
          @enderror
        </div>
        <div class="form-group">
          ...
          <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" 
                    rows="4" placeholder="Tell neighbors what to expect..." required>{{ old('description') }}</textarea>
          @error('description')
            <span class="invalid-feedback">{{ $message }}</span>
          @enderror
        </div>
        <div class="form-row">
          <div class="form-group">
            ...
            <select id="category" name="category" class="form-control @error('category') is-invalid @enderror" required>
              ...
              <option value="Fundraiser" {{ old('category') == 'Fundraiser' ? 'selected' : '' }}>Fundraiser</option>
              <option value="Yard Sale" {{ old('category') == 'Yard Sale' ? 'selected' : '' }}>Yard Sale</option>
          ...
          <div class="form-group">
            ...
            <select id="privacy" name="privacy" class="form-control @error('privacy') is-invalid @enderror" required>
              <option value="public" {{ old('privacy') == 'public' ? 'selected' : '' }}>Public (Visible to all neighbors)</option>
      ...
      <div class="form-section">
        ...
        <div class="form-group">
          ...
          <input type="text" id="location" name="location" class="form-control @error('location') is-invalid @enderror" 
                 placeholder="Enter address or select below" value="{{ old('location') }}" required>
          @error('location')
            <span class="invalid-feedback">{{ $message }}</span>
          @enderror
        </div>
        <div class="location-options">
          <button type="button" class="location-option" data-location="{{ Auth::user()->address }}">
            <span>🏠</span>
            <span>My Home</span>
          </button>
        ...
        <div class="form-group mt-2">
          ...
          <textarea id="location_details" name="location_details" class="form-control @error('location_details') is-invalid @enderror" 
                    rows="2" placeholder="Additional details like which park, room number, etc.">{{ old('location_details') }}</textarea>
      ...
      <div class="form-section">
        ...
        <div class="form-group">
          ...
          <input type="number" id="max_attendees" name="max_attendees" value="{{ old('max_attendees') }}" min="1" class="form-control">
